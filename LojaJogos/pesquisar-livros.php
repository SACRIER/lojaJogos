...
<html>
						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="principal.php" class="logo">
									<span class="symbol"><img src="images/logomini.png" alt="" /></span><span class="title">Jogos pesquisados</span>
								</a>
    ...
    $sql= "SELECT * FROM jogo WHERE nome LIKE '$pesquisar' LIMIT 5";
    ...
    <meta charset='UTF-8'>
        <script type=\"text/javascript\">
            alert(\"INFELIZMENTE O TITULO NAO FOI ENCONTRADO :'(\");
        </script>
        ";
    }       
