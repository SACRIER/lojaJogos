...
<html>
	<head>
		<title>Finalizar compra - SACRIER</title>
		<meta charset="utf-8" />
						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="fecharcompra.php" class="logo">
									<span class="symbol"><img src="images/LOGOjogos.png" alt="" /></span><span class="title">Finalizando a compra</span>
								</a>
					...
					<tbody>
						...
						{   
							...
							//comecando a lista
								...
								$select2 = ("SELECT * FROM jogo WHERE id = '$id'");
								...
								{   
									while($row = $result2->fetch_assoc()) 
									{
										...
										?>
										<tr align='left-left' ondblclick="location.href='jogo.php?id=<?php echo $id ?>';">
											<?php

											
											echo "<td style='font-size:14px;'><b>$nome</b></td>";
							...
							mysqli_close($conn);
							echo	"<li><a href='finalizar.php?nome=$nome&total=$total' class='button primary fit small'>Finalizar</a></li>";
							?>
