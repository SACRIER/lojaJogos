						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="carrinho.php" class="logo">
									<span class="symbol"><img src="images/LOGOjogos.png" alt="" /></span><span class="title">Meu carrinho</span>
								</a>
								...
								{   
									while($row = $result2->fetch_assoc()) 
									{
										...
										<tr align='left-left' ondblclick="location.href='jogo.php?id=<?php echo $id ?>';">
											...
											echo "<td ><a  href='jogo.php?id=$id' ><i class='fa fa-book' aria-hidden='true'></i> $titulo </b></a></td>";
